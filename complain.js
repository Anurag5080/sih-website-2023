function handleButtonClick(button) {
    // Get the button's value (name)
    var buttonValue = button.value;

    // Check if the last radio button is selected
    if (buttonValue === "comment") {
        // Show the comment box
        document.getElementById("comment-box1").style.display = "block";
    } else {
        // Hide the comment box
        document.getElementById("comment-box1").style.display = "none";
    }
}
...
function handleButton(button) {
    ...
    // Check if the last radio button is selected
    if (buttonValue === "specify") {
        // Show the comment box
        document.getElementById("comment-box2").style.display = "block";
    } else {
        // Hide the comment box
...
function handle(button) {
    ...
    // Check if the last radio button is selected
    if (buttonValue === "mannuallocationwrap") {
        // Show the comment box
        document.getElementById("mannuallocationwrap1").style.display = "block";
    } else {
        // Hide the comment box
        document.getElementById("mannuallocationwrap1").style.display = "none";
    }
}
...
function btnclick(button) {
    ...
    // Check if the last radio button is selected
    if (buttonValue === "specified") {
        // Show the comment box
        document.getElementById("specifiedtimeanddate").style.display = "block";
    } else {
        // Hide the comment box
        document.getElementById("specifiedtimeanddate").style.display = "none";
    }
}

function info1Click(button) {
    // Get the button's value (name)
    var buttonValue = button.value;

    // Check if the last radio button is selected
    if (buttonValue === "info1true") {
        // Show the comment box
        document.getElementById("info1box").style.display = "block";
    } else {
        // Hide the comment box
        document.getElementById("info1box").style.display = "none";
    }
}
